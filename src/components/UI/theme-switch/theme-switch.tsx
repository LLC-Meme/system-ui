...
export interface ThemeSwitchContainerProps extends React.HTMLAttributes<HTMLDivElement> {
...
export interface ThemeSwitchButtonProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  current?: boolean;
}
